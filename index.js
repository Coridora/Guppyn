...
async function starts() {
    ...
    •            @${num.split('@')[0]}was E j e c t e d
                      1 impostor restante   。　.
    　 　　。　　 　　　　ﾟ　　　.　      　　
𝒑𝒐𝒙𝒂 𝒄𝒂𝒓𝒂 @${num.split('@')[0]} 🍔𝐬𝐚𝐢𝐮 𝐞 𝐧𝐞𝐦 𝐩𝐚𝐠𝐨𝐮 𝐨 𝐥𝐚𝐧𝐜𝐡𝐞🍟`
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const apiKey = setting.apiKey // contact me on whatsapp wa.me/5511983837806
			...
			mess = {
				...
				only: {
					...
					ownerG: '🚗 Este comando só pode ser usado pelo dono! 🏍️',
					ownerB: ' 🐟Este comando só pode ser usado pelo Coridorazin o brabo 🥶🥶! 🐠',
					admin: ' Este comando só pode ser usado pelos ADMS 😳! ',
					Badmin: ' Da adm q eu faço kkk😎'
				}
			}

			const botNumber = client.user.jid
			const ownerNumber = [`${setting.ownerNumber}@s.whatsapp.net`] // 5511983837806
            const mod = [ownerNumber,"${setting.mod}@s.whatsapp.net"]//5511983837806
            const adminbotnumber = ["${setting.adminbotnumber}@s.whatsapp.net"]//5511983837806
			const frendsowner = ["${setting.frendsowner}@s.whatsapp.net"]//5511983837806
...
case 'antifake':
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*Dono do bot 𝐶𝑜𝑟𝑖𝑑𝑜𝑟𝑎𝑚𝑎𝑘𝑒𝑟 CANAL https://youtube.com/channel/UCiTK8tyEfL0z1s2NBixviPg 
